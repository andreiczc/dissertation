...
public:
  ...
  static uint32_t        RlpEncodeWholeHeader(uint8_t *header_output,
                                              uint32_t total_len);
  static vector<uint8_t> RlpEncodeWholeHeaderWithVector(uint32_t total_len);
  static uint32_t        RlpEncodeItem(uint8_t *output, const uint8_t *input,
                                       uint32_t input_len);
  ...
  static vector<string> *ConvertCharStrToVector32(const char     *resultPtr,
                                                  size_t          resultSize,
